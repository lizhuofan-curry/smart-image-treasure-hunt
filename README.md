...
- **持续集成**：每次推送至 `main` 或提交 Pull Request 时，GitHub Actions 会编译全部 Python 模块，运行三个模型的前向测试、1024 维模拟 KNN 检索、状态字典读写和 Flask 上传测试。
...
- **真实演示材料**：`docs/assets/web-home-full.png` 为本地 Flask CV 主工作区截图，拍摄时间早于 AI 商品介绍功能。
